...
if(strlen($src) && file_exists($src)) {
	...
	} elseif($new_height && $new_width) {	// Tim added this too..
	////// Tim's Modificatios to fit within dimentions and matain aspect ratio //////
	 //\\.......................................................................\\//
	 
		if ( (($width-$new_width) >= 0) || (($height-$new_height) >= 0) ) {  //check if resize is nessassary
